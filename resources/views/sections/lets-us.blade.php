    ...
    <div class="flex">
        <div class="bl-3w">
            <div class="case-bl case-bl-1 show">
                <h3 class="title-lats">Why Choose Us?</h3>
                <p>Trembit is a leading live streaming app development company with over a decade of experience helping clients optimize and modernize their business. Leveraging the latest technology, the team of skilled video conferencing developers will quickly and easily provide you with innovative solutions tailored to your business needs.</p>
                <form method="post" action="https://trembit.com/send.php" target="_top" id="form" novalidate="" class="i-amphtml-form user-invalid">
        ...
        <div class="bl-7w">
            <div class="flex">
                <picture><source srcset="view/images/bg_office.webp" type="image/webp"><img alt="Office" src="view/images/bg_office.png" style="width: 100%;"></picture>
            </div>
        </div>
    </div>
</section>
