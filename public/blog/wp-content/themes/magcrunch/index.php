					...
					<div class="tuck lc-padding">
						<div class="tabs tabs-large">
							<ul class="tab-list tabs-no-select">
                                <li class="latest"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="tabs-no-preventdefault<?php if ( !isset($_GET['order']) || ($_GET['order']!='popular') ) echo ' active'; ?>">Latest</a></li>
                        ...
                        <div class="categoriesSelect">
                            <label for="categoriesDropdown">...</label>
                            <select id="categoriesDropdown" name="event-dropdown" onchange='document.location.href=this.options[this.selectedIndex].value;'>
                                <option value="" selected disabled><?php echo esc_attr('Categories'); ?></option>
                                <?php
                                $categories=  get_categories('');
                                foreach ($categories as $category) {
                                    $option = '<option value="/blog/category/'.$category->category_nicename.'">';
