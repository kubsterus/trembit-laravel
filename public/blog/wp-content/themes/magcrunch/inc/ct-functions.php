...
function ct_popular_posts( $num ) {
    ...
    // save it for 60s
    set_transient('ct_popular_args', $popular, 60);?>
                    ...
                    <?php while ( $popular->have_posts() ) : $popular->the_post(); $count++; ?>
                        <li class="grv_article">
                            <a class="grv_img_link" href="<?php echo esc_url(get_permalink());?>">
                                <img class="grv_article_img" src="<?php echo ct_get_thumbnail_src('main-thumb');?>" width="88" height="60" title="<?php the_title();?>" alt="<?php the_title();?>" />
                            </a>
